...
(function() {
    ...
    LC.LiterallyCanvas = function() {
        function LiterallyCanvas(canvas, opts) {
            ...
            this.backgroundColor = this.opts.backgroundColor || "#FFF";//rgb(230, 230, 230)
...
(function() {
    ...
    initLiterallyCanvas = function(el, opts) {
        ...
        opts = _.extend({
            backgroundColor: "#FFF",//rgb(230, 230, 230)
            imageURLPrefix: "dep/img/literallycanvas/",
...
(function() {
    ...
    LC.toolbarHTML = '<div class="stroke-picker"></div><div class="c_form"><ul class="ul"><li class="li li-submit"><span><button class="ipu-btn e_button-ok" id="get-image">确定</button></span><span><button class="ipu-btn e_button-red">清除</button></span></li></ul></div>';    
    ...
    LC.Toolbar = function() {
        ...
        Toolbar.prototype.initButtons = function() {
            var _this = this;
            this.$el.find(".e_button-red").click(function(e) {
